...
def get_tiktok_cache_path() -> str:
    """
    Gets the path to the TikTok cache file.

    Returns:
        path (str): The path to the TikTok cache file
    """
...
def get_provider_cache_path(provider: str) -> str:
    ...
    Args:
        provider (str): The provider name ("twitter", "youtube", or "tiktok")
    ...
    if provider == "tiktok":
        return get_tiktok_cache_path()

    raise ValueError(f"Unsupported provider '{provider}'. Expected 'twitter', 'youtube', or 'tiktok'.")
